...
[//]: # (Most of the time this involves staring at white boards, pacing back and forth, and muttering to myself, with occasional rushes of pure excitement caused by some new revelation.)
...
{% include figure.html src="https://brianwgoldman.github.io/images/p3-algorithm.png" caption="Algorithm for one iteration of P3." width="50%" height="50%" %}
